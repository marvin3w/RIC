        ...
        n.extend(b.prototype, {
                ...
                if (
                    ...
                    (l = n.fancybox.getTranslate(c.$slide)),
                        ...
                        i
                            ? ((f =
                                  l.left -
                                  (c.pos * l.width + c.pos * c.opts.gutter)),
                              n.each(h.slides, function(t, o) {
                                  ...
                                  var a =
                                      o.pos * l.width + o.pos * o.opts.gutter;
                ...
                return (
                    "image" === i.type &&
                        ...
                        t !== o && e !== o
                            ? (s = { width: t, height: e })
                            : i.isComplete &&
                              (s = n.fancybox.getTranslate(i.$content)),
                        s &&
                            r &&
                            (r =
            ...
            revealContent: function(t) {
                ...
                return (
                    ...
                    (i = parseInt(
                        t.forcedDuration === o ? i : t.forcedDuration,
                        10
                    )),
            ...
            updateControls: function() {
                ...
                o.$slide.trigger("refresh"),
                    ...
                    i
                        ...
                        .prop(
                            "disabled",
                            !o.opts.loop && a >= t.group.length - 1
                        ),
                    "image" === o.type
                        ? i
        ...
        (d.prototype.destroy = function() {
                ...
                if (
                    ...
                    (a.realPoints = a.startPoints = i(o)),
                        a.startPoints.length &&
                            ...
                            (a.contentStartPos = n.fancybox.getTranslate(
                                a.$content
                            ) || { top: 0, left: 0 }),
                            (a.sliderStartPos = n.fancybox.getTranslate(f)),
                            (a.stagePos = n.fancybox.getTranslate(
                                d.$refs.stage
                            )),
                            ...
                            (((a.opts || a.canPan) &&
                                ...
                                n.fancybox.isMobile &&
                                    c.hasClass("fancybox-caption"))) &&
                                ((a.isScrollable = l(c) || l(c.parent())),
                                (n.fancybox.isMobile && a.isScrollable) ||
                                    o.preventDefault(),
            ...
            (d.prototype.limitMovement = function() {
                ...
                return (
                    ...
                    l > 0 &&
                        a > t &&
                        (a = t - 1 + Math.pow(-t + f + l, 0.8) || 0),
                    l < 0 &&
                        a < n &&
                        (a = n + 1 - Math.pow(n - f - l, 0.8) || 0),
                    d > 0 &&
                        i > e &&
                        (i = e - 1 + Math.pow(-e + p + d, 0.8) || 0),
                    d < 0 &&
                        i < o &&
                        (i = o + 1 - Math.pow(o - p - d, 0.8) || 0),
                    { top: i, left: a }
                );
            }),
        ...
        e.extend(n.prototype, {
            ...
            set: function(t) {
                var n = this,
                    ...
                    a = o.current;
                a &&
                (t === !0 || a.opts.loop || o.currIndex < o.group.length - 1)
                    ? n.isActive &&
                      "video" !== a.contentType &&
                      (n.$progress &&
                          e.fancybox.animate(
            ...
            focus: function(t) {
                ...
                a.instance.current &&
                    ((e = i
                        ...
                        .removeClass(o)
                        .filter(
                            '[data-index="' + a.instance.current.index + '"]'
                        )
                        .addClass(o)),
                    (n = e.position()),
                    "y" === a.opts.axis &&
